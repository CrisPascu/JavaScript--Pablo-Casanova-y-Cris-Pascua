...
describe("Testing IMC", function () {
    it("hombre mayor 18", function () {
        calcularIMC(1.8,3.24*18,"hombre",24).should.be.equal("18 - bajo peso"); 
    ...
    it("hombre  17", function () {
        calcularIMC(1.8,3.24*18,"hombre",17).should.be.equal("18 - bajo peso"); 
    ...
    it("mujer  17", function () {
        ...
        calcularIMC(1.7,2.89*30,"mujer",17).should.be.equal("30 - obesidad"); 
    });  
